...
import geniusweb.profile.utilityspace.LinearAdditiveUtilitySpace as LinearAdditiveUtilitySpace
import genius2.references.ProfileRef as ProfileRef
import genius2.references.ProtocolRef as ProtocolRef
...
import genius2.progress.ProgressRounds as ProgressRounds
...
class RandomParty (DefaultParty):
	...
	def getCapabilities(self): # -> Capabilities
		try:
			...
			getReporter().log(Level.SEVERE, "Failed to create capabilities URI",e);
		return None
